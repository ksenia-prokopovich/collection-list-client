        ...
        return <div className="form-collection container">
            <form>
                ...
                <div className="mb-3">
                    ...
                    <textarea rows="5" value={this.state.description} class=" form-control" id=" exampleInputTitle"
                              name=" content" onChange={this.descriptionChange.bind(this)}/>
                </div>
                <button type="submit" class=" btn btn-dark" onClick={this.add.bind(this)}>Add</button>
            </form>
        </div>
    }
}
